...
#define JELOG_SHORT_LEVEL_NAMES \
    ...
    char *NameFromLevel(Level);

    Level LevelFromName(char *);
...
#pragma region JeTime
    ...
    public:
        ...
        virtual int64_t MilliSecond() override;
...
#pragma region JsonFormatter
    ...
    public:
        ...
        ///
        /////////////////////////////////////////////////////////////////////////
        virtual void TimeFormat(LogRecord &, char *);
...
#pragma region Level
    ...
    char *NameFromLevel(Level level)
    {
